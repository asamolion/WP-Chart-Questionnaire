...
(function() {
        ...
        Tipsy.prototype = {
            ...
            fixTitle: function() {
                ...
                if (
                    ...
                    return $e
                        .attr("original-title", $e.attr("title") || "")
                        .removeAttr("title");
                }
            },
            getTitle: function() {
    ...
    $.fn.extend({
        multistep: function(options) {
            ...
            this.find(".step")
                .first()
                .css("display", "block");
            this.find(".step:not(:first)").append(
                '<a href="#" class="back"></a>'
            );
            window.valid = false;
            form = this;
            ...
            $(
                "input:not([type=image],[type=button],[type=submit],[type=radio],[type=checkbox])",
                form
            ).keyup(function() {
                var min, skip, _ref;
                ...
                if (
                    ...
                    $(this)
                        .attr("class")
                        .match(specialRegEx) != null
                ) {
                    skip = true;
                }
                if (
                    !(
                        $(this).attr("optional") === "yes" ||
                        $(this).val().length < min ||
                        skip != null
                    )
                ) {
            ...
            $("input[type=checkbox]", form).change(function(e) {
                ...
                if (
                    ...
                    $("input[name=" + inputName + "]:checked").length <= max &&
                    $("input[name=" + inputName + "]:checked").length >= min
                ) {
                    $("input[name=" + inputName + "]")
                        .first()
                        .tipsy("hide");
            ...
            return $(".step .submit", form).click(function(e) {
                ...
                window.validitems = 0;
                $(
                    "input:not([type=image],[type=button],[type=submit],[type=radio],[type=checkbox]):visible",
                    thisStep
                ).each(function() {
                    window.totalitems++;
                    if (
                ...
                $("input[type=radio]:visible", thisStep).each(function() {
                    ...
                    if (
                        ...
                        $("input[name=" + name + "]:hidden").length ||
                        $("input[name=" + name + "][optional=yes]").length
                    ) {
                        return window.validitems++;
                    } else {
                        $("input[name=" + name + "]")
                            .first()
                            .attr("original-title", "Select One!");
                        $("input[name=" + name + "]")
                            .first()
                            .tipsy({
                                trigger: "manual",
                ...
                $("input[type=checkbox]:visible", thisStep).each(function() {
                    ...
                    if (
                        $("input[name=" + inputName + "]").is(":checked") &&
                        $("input[name=" + inputName + "]:checked").length <=
                            max &&
                        $("input[name=" + inputName + "]:checked").length >= min
                    ) {
                        $("input[name=" + inputName + "]")
                ...
                if (window.totalitems === window.validitems) {
                    if (thisStep.attr("id") !== "last-step") {
                        ...
                        if (
                            (options != null ? options.beforeSubmit : void 0) !=
                            null
                        ) {
    ...
    $(function() {
        $(
            "input:not([type=button],[type=image],[type=submit],[type=radio],[type=checkbox]),select"
        ).each(function() {
            return $(this).tipsy({
                trigger: "manual",
                gravity: "w",
