...
// Project related.
var project                 = 'Polar Chart Questionnaire'; // Project Name.
var projectURL              = 'wocker.test'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'en-US'; // Your textdomain here.
var translationFile         = 'en-US.pot'; // Name of the transalation file.
...
var jsCustomDestination     = './public/js/'; // Path to place the compiled JS custom scripts file.
var jsCustomFile            = 'custom'; // Compiled JS custom file name.
// Default set to custom i.e. custom.js.

// Images related.
var imagesSRC               = './assets/images/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
var imagesDestination       = './public/images/'; // Destination folder of optimized images. Must be different from the imagesSRC folder.
